...
public class MockWithOAuth2UserSecurityContextFactory implements WithSecurityContextFactory<MockWithOAuth2User> {

    @Override
    public SecurityContext createSecurityContext(MockWithOAuth2User withUser) {
